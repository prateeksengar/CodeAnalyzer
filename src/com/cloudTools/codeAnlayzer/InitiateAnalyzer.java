...
public class InitiateAnalyzer {
	...
	{
		QueryResult qr = toolingConnection.query("select Id,Name,LengthWithoutComments,Body,SymbolTable from ApexClass where NamespacePrefix = null order by Name limit 10");
		Boolean done = false;
